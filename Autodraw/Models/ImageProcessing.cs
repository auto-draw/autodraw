...
public static class ImageProcessing
{
    ...
    public static Filters _currentFilters = new(invert: false, maxThreshold: 127, alphaThreshold: 200);
    ...
    public class Filters(
        byte alphaThreshold = 127,
        byte maxThreshold = 127,
        byte minThreshold = 0,
        bool crosshatch = false,
        bool diagCrosshatch = false,
        decimal horizontalLines = 0,
        decimal verticalLines = 0,
        bool invert = false,
        bool outline = false,
        int borderAdvanced = 0,
        int outlineAdvanced = 0,
        int inlineAdvanced = 0,
        int inlineBorderAdvanced = 0,
        int erosionAdvanced = 0)
    {
        public byte AlphaThreshold { get; set; } = alphaThreshold;
        public byte MaxThreshold { get; set; } = maxThreshold;
        public byte MinThreshold { get; set; } = minThreshold;
    
        public bool Crosshatch { get; set; } = crosshatch;
        public bool DiagCrosshatch { get; set; } = diagCrosshatch;
        public decimal HorizontalLines { get; set; } = horizontalLines;
        public decimal VerticalLines { get; set; } = verticalLines;
    
        public bool Invert { get; set; } = invert;
        public bool Outline { get; set; } = outline;

        public int BorderAdvanced { get; set; } = borderAdvanced;
        public int OutlineAdvanced { get; set; } = outlineAdvanced;
        public int InlineAdvanced { get; set; } = inlineAdvanced;
        public int InlineBorderAdvanced { get; set; } = inlineBorderAdvanced;
        public int ErosionAdvanced { get; set; } = erosionAdvanced;
    }
